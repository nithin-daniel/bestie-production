    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resort_service_3', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_service_4', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_service_5', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_service_6', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_service_7', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_service_8', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_aminities_1', models.CharField(max_length=100)),
                ('resort_aminities_2', models.CharField(max_length=100)),
                ('resort_aminities_3', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_aminities_4', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_aminities_5', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_aminities_6', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_aminities_7', models.CharField(blank=True, max_length=100, null=True)),
                ('resort_aminities_8', models.CharField(blank=True, max_length=100, null=True)),
